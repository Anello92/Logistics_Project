# Project 1 - Building and Deploying a Machine Learning Model
...
# Apply the transformation on the training and test data for the categorical variable Package_Type
...
# Apply the transformation on the training and test data for the categorical variable Product_Type
